...
public class registerstudents extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton7.setText("Print List Of Students");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        MessageFormat header = new MessageFormat("List of all Students");
        MessageFormat footer = new MessageFormat("Page{0, number, footer}");
        try{
            jTable2.print(JTable.PrintMode.NORMAL, header, footer);
            JOptionPane.showMessageDialog(null, "List of Students Printed Successful!!");
        }catch(Exception e){
