...
public class allstudentsresults extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton8.setText("Print Results");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        // TODO add your handling code here:
        MessageFormat header = new MessageFormat("List of all Students Results");
        MessageFormat footer = new MessageFormat("Page{0, number, footer}");
        try{
            jTable1.print(JTable.PrintMode.NORMAL, header, footer);
            JOptionPane.showMessageDialog(null, "Student Results Printed Successful!!");
        }catch(Exception e){
