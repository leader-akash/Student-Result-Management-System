...
public class updateresult extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (rs.next()) {
            // The student exists in the database, so update their results
            String updateQuery = "UPDATE result SET physics=?, maths=?, em=?, dbms=?, os=? WHERE rollno=?";
            PreparedStatement updateStmt = con.prepareStatement(updateQuery);
            updateStmt.setString(1, physics);
            updateStmt.setString(2, maths);
            updateStmt.setString(3, em);
            updateStmt.setString(4, dbms);
            updateStmt.setString(5, os);
            updateStmt.setString(6, rollno);
            int rowsUpdated = updateStmt.executeUpdate();
            if (rowsUpdated > 0) {
                JOptionPane.showMessageDialog(null, "Student Result Updated Successfully!!");
            } else {
                JOptionPane.showMessageDialog(null, "Student Result Update Failed!!");
            }
        } else {
